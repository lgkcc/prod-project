...
describe('Modal Tests', () => {
  test('Test render with children', () => {
    render(<Modal isOpen setIsOpen={onClick}>test</Modal>);
  ...
  test('Not show test', () => {
    render(<Modal isOpen={false} setIsOpen={onClick}>test</Modal>);
    expect(screen.getByTestId('Modal')).not.toHaveClass('open');
  });
  test('Click overlay test', () => {
    render(<Modal setIsOpen={onClick} isOpen>test</Modal>);
